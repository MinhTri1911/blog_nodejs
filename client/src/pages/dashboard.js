...
class DashBoard extends Component {
    callApiDemo = async () => {
        // localStorage.setItem('x-auth', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI1YWJiMTdlNzAwMGFjYjU3N2JkZGU1YTUiLCJhY2Nlc3MiOiJhdXRoIiwiaWF0IjoxNTIyMjEwNzkxfQ.ivSXrKpT_r7wyb2FK4bOimP-Lme9Rzo5HXBkolkw1RA')
        let data = await Api.get('users/list', null)
        ...
        return (
            <div id='content'>
                ...
                <div className="col-md-12 row">
                    <button className="btn btn-primary" onClick={this.callApiDemo}>Demo Request</button>
                </div>
                    <div className="row">
